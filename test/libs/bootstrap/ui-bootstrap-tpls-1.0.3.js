    ...
    if (isMaxSized && maxSize > 0 && (!rotate || forceEllipses || boundaryLinkNumbers)) {
      if (startPage > 1) {
        ...
        if (boundaryLinkNumbers) {
          if (startPage === 3) { //need to replace ellipsis when the bootstrap would be sequential
      ...
      if (endPage < totalPages) {
        ...
        if (boundaryLinkNumbers) {
          if (endPage === totalPages - 2) { //need to replace ellipsis when the bootstrap would be sequential
